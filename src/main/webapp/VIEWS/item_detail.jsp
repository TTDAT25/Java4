	...
	<div class="row p-4 p-md-0">
		<div class="col-12 col-md-8">
			...
			<div class="row d-flex w-75 ">
				<img class="img-thumbnail w-25 me-1" src="${product.hinh[0].tenhinh}"> <img class="img-thumbnail w-25 me-1" src="${product.hinh[0].tenhinh}"> <img class="img-thumbnail w-25 me-1" src="${product.hinh[0].tenhinh}">
			</div>
		</div>
			...
			<div class="card text-center border-0 ">
				...
				<div class="card-body border-0 pt-1">
					...
					<form method="get" class="mt-2 size row d-flex justify-content-center column-gap-2 column-gap-lg-2">
						<c:forEach var="size" items="${product.spSize}">
							<input type="radio" class="btn-check btn-size col-3 col-lg-2 btn" name="size" value="${size.size.masize}" id="${size.size.tensize}" autocomplete="off">
		...
		<button id="testClcik">tesst</button>
	</div>
...
var button = document.getElementById("testClcik");
